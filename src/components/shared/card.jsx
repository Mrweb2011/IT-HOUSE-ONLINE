    ...
    <div>
        <div className="flex justify-center mt-10">
            ...
            <div className="column">
                <h1 className='font-bold text-3xl'>Mashhur Kurslarni Ko'rib Chiqing</h1>
                <h4 className='font-semibold text-gray-500'>Hozirgi kunda talab yuqori bo'lgan IT kurslari.</h4>
            </div>
            <div className="flex">
                <button className='bg-gray-200 px-5 py-2 rounded-3xl font-semibold ml-1'>Hammasi</button>
                <button className='bg-gray-200 px-5 py-2 rounded-3xl font-semibold ml-1'>Eng yangi</button>
                <button className='bg-gray-200 px-5 py-2 rounded-3xl font-semibold ml-1'>Eng past narx</button>
                <button className='bg-gray-200 px-5 py-2 rounded-3xl font-semibold ml-1'>Eng yuqori narx</button>
            </div>
            </div>
        </div>
        ...
        <div className="border-2 rounded-2xl">
            ...
            <h1 className='font-semibold mx-3'>Django, Postgresql, Djangorest framework, JS ,...</h1>
            <h1 className='text-gray-500 text-xs font-semibold'><s>1,200,000<br />so'm</s></h1>
            <h1 className='font-semibold mx-3'>1,000,000<br />so'm</h1>
            </div>
        </div>            
        <div className="border-2 rounded-2xl">
            ...
            <h1 className='font-semibold mx-3'>Ms Word, Ms Exsel & Ms PowerPoint</h1>
            <div className="flex gap-2">
            <h1 className='text-gray-500 text-xs font-semibold'><s>1,200,000 so'm</s></h1>
        ...
        <div className="border-2 rounded-2xl">
            ...
            <div className="flex gap-2">
            <h1 className='text-gray-500 text-xs font-semibold'><s>0 so'm</s></h1>
        ...
        <div className="border-2 rounded-2xl">
            ...
            <div className="flex gap-2">
            <h1 className='text-gray-500 text-xs font-semibold'><s>3,000,000 so'm</s></h1>
        ...
        <div className="border-2 rounded-2xl">
            ...
            <h1 className='font-semibold mx-3'>C# dasturlash tiliga kirish</h1>
            <div className="flex gap-2">
            <h1 className='text-gray-500 text-xs font-semibold'><s>3,000,000 so'm</s></h1>
